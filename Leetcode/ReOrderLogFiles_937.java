    ...
    public String[] reorderLogFiles(String[] logs) {
        Comparator<String> myComp = new Comparator<String>() {
            ...
            public int compare(String s1,String s2) {
                int s1k = s1.indexOf(' ');
                int s2k = s2.indexOf(' ');
                char s1c = s1.charAt(s1k+1);
                char s2c = s2.charAt(s2k+1);
                ...
                int preCompute = s1.substring(s1k+1).compareTo(s2.substring(s2k+1));
                if (preCompute == 0) return s1.substring(0,s1k).compareTo(s2.substring(0,s2k));
                    return preCompute;
             }
        };
